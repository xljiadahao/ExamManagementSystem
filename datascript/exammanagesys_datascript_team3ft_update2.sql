...
insert into QUESTION(QUESTION_SEQUENCE,VERSION_NUMBER,FK_CREATED_BY,MARK,QUESTION_STATUS) values(1,'V1','L0120000L',10,'DISABLE');
insert into QUESTION(QUESTION_SEQUENCE,VERSION_NUMBER,FK_CREATED_BY,MARK,QUESTION_STATUS) values(1,'V2','L0120000L',20,'ENABLE');
insert into QUESTION(QUESTION_SEQUENCE,VERSION_NUMBER,FK_CREATED_BY,MARK,QUESTION_STATUS) values(2,'V1','L0120000L',20,'ENABLE');
insert into QUESTION(QUESTION_SEQUENCE,VERSION_NUMBER,FK_CREATED_BY,MARK,QUESTION_STATUS) values(3,'V1','L0120000L',30,'ENABLE');
insert into QUESTION(QUESTION_SEQUENCE,VERSION_NUMBER,FK_CREATED_BY,MARK,QUESTION_STATUS) values(4,'V1','L0120000L',20,'ENABLE');
insert into QUESTION(QUESTION_SEQUENCE,VERSION_NUMBER,FK_CREATED_BY,MARK,QUESTION_STATUS) values(5,'V1','L0120001L',20,'ENABLE');
insert into QUESTION(QUESTION_SEQUENCE,VERSION_NUMBER,FK_CREATED_BY,MARK,QUESTION_STATUS) values(6,'V1','L0120001L',30,'ENABLE');
insert into QUESTION(QUESTION_SEQUENCE,VERSION_NUMBER,FK_CREATED_BY,MARK,QUESTION_STATUS) values(7,'V1','L0120011L',10,'ENABLE');
insert into QUESTION(QUESTION_SEQUENCE,VERSION_NUMBER,FK_CREATED_BY,MARK,QUESTION_STATUS) values(8,'V1','L0120011L',10,'ENABLE');
insert into QUESTION(QUESTION_SEQUENCE,VERSION_NUMBER,FK_CREATED_BY,MARK,QUESTION_STATUS) values(9,'V1','L0120002L',20,'ENABLE');
insert into QUESTION(QUESTION_SEQUENCE,VERSION_NUMBER,FK_CREATED_BY,MARK,QUESTION_STATUS) values(10,'V1','L0120002L',20,'ENABLE');
insert into QUESTION(QUESTION_SEQUENCE,VERSION_NUMBER,FK_CREATED_BY,MARK,QUESTION_STATUS) values(11,'V1','L0120002L',20,'ENABLE');
